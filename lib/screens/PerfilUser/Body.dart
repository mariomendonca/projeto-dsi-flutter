        ...
        children: [
          Container(
            ...
            child: (Text('Doutor Adrian',
                style: TextStyle(color: Color.fromRGBO(0, 191, 186, 1),fontWeight: FontWeight.bold))),
          ),
          Column(
            mainAxisAlignment: MainAxisAlignment.center,
            ...
            children: [
              Container(
                  ...
                  child: (Text('Qui',
                      style:
                          TextStyle(color: Color.fromRGBO(0, 191, 186, 1),fontWeight: FontWeight.bold)))),
              Container(
                width: size.width * 0.2,
                child: (Text('18h às 19h',
                    style: TextStyle(fontSize: 12,color: Color.fromRGBO(0, 191, 186, 1),fontWeight: FontWeight.bold))),
              ),
            ],
          )
        ],
